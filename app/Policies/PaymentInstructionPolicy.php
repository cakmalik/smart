...
class PaymentInstructionPolicy
{
     ...
     */
    public function restore(User $user, PaymentInstruction $paymentInstruction): bool
    {
        //
    }
     ...
     */
    public function forceDelete(User $user, PaymentInstruction $paymentInstruction): bool
    {
        //
    }
}
