...
class InvoiceController extends Controller
{
    ...
    {
        $invoices = $this->invoiceQuery($request)->where('status', 'unpaid')->orderByDesc('id')->get();
    ...
    {
        $invoice = Invoice::with('method')->where('invoice_number', $invoice_number)->first();
        // dd($invoice);

        $invoice->load('file', 'method');
