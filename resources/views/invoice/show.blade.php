            ...
            <div class="w-full grid grid-col sm:grid-cols-3 gap-4" v-if="!isUpload">
                    ...
                    <div class="grid grid-col sm:flex justify-between gap-3">
                        ...
                        @if ($invoice->file?->id)
                            @switch($invoice->file->status)
                                @case('approved')
                                    <h3
                                        class="uppercase px-3 rounded-lg border sm:h-7 text-center border-green-500 bg-green-200 font-semibold">
                                        dibayar
                                    </h3>
                                @break
                                ...
                                @case('waiting')
                                    <h3
                                        class="uppercase px-3 rounded-lg border sm:h-7 text-center border-yellow-500 bg-yellow-200 font-semibold">
                                ...
                                @default
                                    <h3
                                        class="uppercase px-3 rounded-lg border sm:h-7 text-center border-red-500 bg-red-200 font-semibold">
                                        ditolak
                                    </h3>
                            @endswitch
                        @else
                ...
                @elseif($invoice->status == 'waiting' && $invoice->file?->status == 'reject')
                    <div class="w-full bg-red-50 p-3 rounded-lg">
                        <h3 class=" text-xl font-semibold">Alasan penolakan :</h3>
                        <p>{{ $invoice->file?->desc }}</p>
                        @can('change payment method')
                            <div class="mt-3">
                                <button @click.prevent="toggle('isUpload')"
                                    class="flex items-center gap-2 px-3 py-1 sm:py-4 bg-yellow-300 ring-2 ring-green-700 sm:rounded-full hover:bg-slate-200 text-base">
                                    ...
                                    <span class="text-center"> Upload Ulang Bukti Pembayaran</span>
