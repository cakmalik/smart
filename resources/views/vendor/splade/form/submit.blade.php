...
<button
    {{ $attributes->class([
            'border rounded-full shadow-sm font-bold py-2 px-4 focus:outline-none focus:ring focus:ring-opacity-50',
            ...
            'bg-white hover:bg-gray-100 text-gray-700 border-gray-300 focus:border-green-300 focus:ring-green-200' =>
