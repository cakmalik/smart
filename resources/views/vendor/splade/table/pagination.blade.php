                        ...
                        @foreach ($element as $page => $url)
                            @if ($page == $paginator->currentPage())
                                <span aria-current="page">
                                    <span
                                        class="relative inline-flex items-center px-4 py-2 -ml-px text-xs sm:text-sm font-medium bg-green-50 border-green-500 text-green-600 z-10 border cursor-default leading-5">{{ $page }}</span>
                                </span>
                            @else
