<Menu>
    <div class="grid grid-cols-3 gap-1 ">
        ...
        @can('access permit')
            <x-menu.new.single-menu link="{{ route('permittion.index') }}" label="Permittion"
        ...
        @can('submission')
            <x-menu.new.single-menu link="{{ route('submission.index') }}" label="Pengajuan" icon="ph-arrow-fat-lines-up" />
        @endcan
        {{-- PROFILE --}}
        <div class="">
