    <x-splade-toggle data="isShowMobileMenu">
        <div id="mobileMenuId"
            class="fixed z-50 w-full h-16 max-w-lg -translate-x-1/2 bg-white border border-gray-200 rounded-full bottom-4 left-1/2 dark:bg-gray-700 dark:border-gray-600 duration-300 ease-in-out transition-opacity">
            <div class="relative grid h-full max-w-lg grid-cols-5 mx-auto">
                ...
                <button @click.prevent="toggle('isShowMobileMenu')" data-tooltip-target="tooltip-settings"
                    type="button"
                    class="inline-flex flex-col items-center justify-center px-5 hover:bg-gray-50 dark:hover:bg-gray-800 group">
                ...
                <div class="absolute left-0 right-0 grid h-48 grid-cols-3 mx-3 text-center duration-300 bg-white rounded-lg -top-52"
        ...
        document.getElementById('mobileMenuId').style.visibility = "visible";
            ...
            if (event.deltaY < 0) { stickyButton.classList.remove('hidden'); stickyButton.classList.remove('opacity-0');
                stickyButton.classList.add('opacity-100'); } else if (event.deltaY> 0) {
