            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-8">
                {{-- <a href="https://laravel.com/docs"
                    ...
                    <div>
                        ...
                        <h2 class="mt-6 text-xl font-semibold text-gray-900">Masuk</h2>
                ...
                <a href="https://laracasts.com"
                    ...
                    <div>
                        ...
                        <h2 class="mt-6 text-xl font-semibold text-gray-900">Mendaftar</h2>
        ...
        <div class="flex justify-center mt-16 px-0 sm:items-center sm:justify-between gap-3">
            @if ($canLogin)
                ...
                @else
                    ...
                    <span
                        class="absolute flex items-center justify-center w-full h-full text-green-500 transition-all duration-300 transform group-hover:translate-x-full ease">Masuk</span>
                    ...
                    @if ($canRegister)
                        ...
                        <span
                            class="absolute flex items-center justify-center w-full h-full text-green-500 transition-all duration-300 transform group-hover:-translate-x-full ease">Mendaftar</span>
