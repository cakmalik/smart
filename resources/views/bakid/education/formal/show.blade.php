<x-app-layout>
    <x-splade-modal>
        <x-splade-form :default="$formal" :action="route('formal.update', $formal->id)" class="flex flex-col gap-4" method="put" stay background
            @success="$splade.emit('formal-updated')">
            ...
            <div class="flex
                ...
                <Link confirm="Delete..." confirm-text="Are you sure?" confirm-button="Yes, take me there!"
                    cancel-button="No, keep me save!" href="{{ route('formal.destroy', $formal->id) }}" method="delete"
