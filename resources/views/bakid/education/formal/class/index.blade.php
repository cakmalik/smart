                ...
                <div id="accordion-collapse-body-{{ $i->id }}" class="hidden"
                    ...
                    <div class="p-5 border border-b-0 border-gray-200 dark:border-gray-700 dark:bg-gray-900">
                        <div class="flex flex-wrap gap-2">
                            ...
                            @endforelse
                            <div class=" grow flex justify-center items-center card text-gray-500 border rounded-md border-gray-200 px-2 py-1 bg-gray-100 hover:bg-wa-teal1 hover:text-white cursor-pointer">
