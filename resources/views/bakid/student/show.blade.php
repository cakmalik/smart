<x-app-layout>
    <x-splade-modal>
        <x-splade-data remember="show" default="{active:'main'}">
            <button class="py-1 px-3 rounded-full bg-wa-teal2" v-show="data.active!='main'" @click="data.active='main'">
            ...
            <aside v-show="data.active=='kts'">
                sdfsddddddddddddddddddddd
            </aside>

            <aside v-show="data.active=='mahram'">
                asdasdasd
            </aside>
        </x-splade-data>
