                                    ...
                                    <x-slot:form>
                                        ...
                                        @if (count($availablePermissions) > 0)
                                            <div class="col-span-6">
                                                <x-splade-checkboxes name="permissions" label="Permissions"
                                                    class="grid grid-cols-1 md:grid-cols-2 gap-1" :options="array_combine(
                                                ...
                                                @foreach ($tokens as $token)
                                                    <div class="flex items-center justify-between">
                                                        ...
                                                        <div class="flex items-center ml-2">
                                                            ...
                                                            <x-splade-form method="delete" :action="route('api-tokens.destroy', $token['id'])"
                                                                :confirm-danger="__('Delete API Token')" :confirm-text="__(
